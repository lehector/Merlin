...
(constraint (= (fun "Nancy FreeHafer") "Dr. Nancy"))
(constraint (= (fun "Andrew Cencici") "Dr. Andrew"))
(constraint (= (fun "Jan Kotas") "Dr. Jan"))
(constraint (= (fun "Mariya Sergienko") "Dr. Mariya"))
