...
(constraint (= (fun "Launa|Withers") "Launa Withers"))
(constraint (= (fun "Lakenya|Edison") "Lakenya Edison"))
(constraint (= (fun "Brendan|Hage") "Brendan Hage"))
(constraint (= (fun "Bradford|Lango") "Bradford Lango"))
(constraint (= (fun "Rudolf|Akiyama") "Rudolf Akiyama"))
(constraint (= (fun "Lara|Constable") "Lara Constable"))
