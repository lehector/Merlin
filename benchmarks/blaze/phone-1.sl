...
(constraint (= (fun "938-242-504") "242"))
(constraint (= (fun "308-916-545") "916"))
(constraint (= (fun "623-599-749") "599"))
(constraint (= (fun "981-424-843") "424"))
(constraint (= (fun "118-980-214") "980"))
(constraint (= (fun "244-655-094") "655"))
