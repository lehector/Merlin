...
(constraint (= (fun "Launa|Withers") "Withers, L."))
(constraint (= (fun "Lakenya|Edison") "Edison, L."))
(constraint (= (fun "Brendan|Hage") "Hage, B."))
(constraint (= (fun "Bradford|Lango") "Lango, B."))
(constraint (= (fun "Rudolf|Akiyama") "Akiyama, R."))
