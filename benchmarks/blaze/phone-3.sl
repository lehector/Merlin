...
(constraint (= (fun "938-242-504") "(938) 242-504"))
(constraint (= (fun "308-916-545") "(308) 916-545"))
(constraint (= (fun "623-599-749") "(623) 599-749"))
(constraint (= (fun "981-424-843") "(981) 424-843"))
(constraint (= (fun "118-980-214") "(118) 980-214"))
(constraint (= (fun "244-655-094") "(244) 655-094"))
(constraint (= (fun "830-941-991") "(830) 941-991"))
